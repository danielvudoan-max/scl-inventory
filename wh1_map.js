...
+ '.wh1map-ov{display:none;position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;align-items:flex-end;justify-content:center}'
...
+ '<g><rect x="2" y="2" width="62" height="50" rx="4" fill="#C8A882" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z5\')"/>'
+ '<text x="33" y="21" font-family="Courier New" font-size="8" font-weight="700" fill="#3d2a10" text-anchor="middle" pointer-events="none">Zone 5</text>'
+ '<text x="33" y="33" font-family="Courier New" font-size="7" fill="#3d2a10" text-anchor="middle" pointer-events="none">15A·15B</text>'
+ '<text x="33" y="43" font-family="Courier New" font-size="7" fill="#3d2a10" text-anchor="middle" pointer-events="none">15C·15D</text></g>'
+ '<g><rect x="66" y="2" width="62" height="50" rx="4" fill="#E8D5F2" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z4a\')"/>'
...
+ '<text x="213" y="33" font-family="Courier New" font-size="7" fill="#3a1f5a" text-anchor="middle" pointer-events="none">9G·9H·9I·9J</text>'
+ '<text x="213" y="43" font-family="Courier New" font-size="7" fill="#3a1f5a" text-anchor="middle" pointer-events="none">9K·9L·9M</text></g>'
// Horizontal walkway
...
+ '<text x="34" y="156" font-family="Courier New" font-size="8" font-weight="700" fill="#2a4400" text-anchor="middle" pointer-events="none">Zone 7</text>'
+ '<text x="34" y="168" font-family="Courier New" font-size="7" fill="#2a4400" text-anchor="middle" pointer-events="none">5A-D·7A-D</text></g>'
+ '<rect x="68" y="133" width="7" height="56" rx="2" fill="url(#wh1-hatch)"/>'
+ '<g><rect x="77" y="133" width="52" height="56" rx="4" fill="#FFF2A8" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z8\')"/>'
+ '<text x="103" y="156" font-family="Courier New" font-size="8" font-weight="700" fill="#4a3f0a" text-anchor="middle" pointer-events="none">Zone 8</text>'
+ '<text x="103" y="168" font-family="Courier New" font-size="7" fill="#4a3f0a" text-anchor="middle" pointer-events="none">9N·5E·9O</text></g>'
+ '<rect x="131" y="133" width="17" height="56" fill="#111"/>'
+ '<g><rect x="150" y="133" width="128" height="56" rx="4" fill="#C49FE0" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z6\')"/>'
+ '<text x="214" y="156" font-family="Courier New" font-size="8" font-weight="700" fill="#3a0f5a" text-anchor="middle" pointer-events="none">Zone 6</text>'
+ '<text x="214" y="168" font-family="Courier New" font-size="7" fill="#3a0f5a" text-anchor="middle" pointer-events="none">6A · 6B · 9P</text></g>'
// Horizontal walkway
+ '<rect x="2" y="193" width="276" height="7" fill="url(#wh1-hatch)"/>'
// Bottom row: Zone 1 | Zone 3
+ '<g><rect x="2" y="203" width="136" height="90" rx="4" fill="#F4A030" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z1\')"/>'
+ '<text x="70" y="240" font-family="Courier New" font-size="10" font-weight="700" fill="#3d1a00" text-anchor="middle" pointer-events="none">Zone 1</text>'
+ '<text x="70" y="254" font-family="Courier New" font-size="7" fill="#3d1a00" text-anchor="middle" pointer-events="none">1·4A·4B·4C·10A–10E</text></g>'
+ '<g><rect x="142" y="203" width="136" height="90" rx="4" fill="#7DC87D" style="cursor:pointer" onclick="window.__wh1mapOpenZone(\'z3\')"/>'
+ '<text x="210" y="240" font-family="Courier New" font-size="10" font-weight="700" fill="#0f2e0f" text-anchor="middle" pointer-events="none">Zone 3</text>'
